	...
	static Watcher watcher = new Watcher() {
		public void process(WatchedEvent event) {
			...
			try {
				...
				System.out.println("node3开始向zk服务端注册>>>>>>");
				String path = zk.create("/nodeManager/tempNode3","node3".getBytes(), Ids.OPEN_ACL_UNSAFE,CreateMode.EPHEMERAL);
